...
<head>
    ...
    <link rel="stylesheet" href="../css/styleautoridades.css">
</head>
<body>
        <header>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="./autoridades.php">DIRECTIVOS</a>
                  </li>
                  <li class="nav-item">
    ...
    <script src="../js/script-carouselEvent.js" defer></script>
